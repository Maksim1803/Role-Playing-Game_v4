...
public class FantasyCharacter {
    ...
    public void decreaseGold(int price, int potion_health) {
        if (gold >= price) {
            ...
            System.out.println("Герой " + this.name + " потратил " + price + " золотых." +
                    "Зелье приобретено и здоровье увеличилось на " + potion_health + " единиц." +
   ...
   // public void buyPotion(int price, int potion_health) {
    //    if (gold >= price) {
    //        health += potion_health;
    //        gold -= price;
    //        System.out.println("Зелье приобретено и здоровье увеличилось на " + potion_health + " единиц. Остаток золота: " + gold);
    //    } else {
    //        System.out.println("У героя недостаточно золота для покупки зелья.");
    //    }
    //}
}
